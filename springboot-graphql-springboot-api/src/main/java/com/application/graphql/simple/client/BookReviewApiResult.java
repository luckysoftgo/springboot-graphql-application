package com.application.graphql.simple.client;

import com.application.graphql.simple.model.BookReview;
import com.application.graphql.simple.model.Review;
...
public record BookReviewApiResult(ResultData data, String error) {
    ...
    public BookReview toBookReview() {
        ResultData.QueryName getBookByIsbn = this.data().getBookByIsbn();
